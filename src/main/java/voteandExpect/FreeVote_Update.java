...
/**
 * Servlet implementation class FreeVote_Update
 */
public class FreeVote_Update extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FreeVote_Update() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		VoteLogInsData = new VoAndExp_TO(Anc_Code, K_ID, Date_Changer.toDateString(Now), VoteSel);
		ExpLogInsData = new VoAndExp_TO(Anc_Code, K_ID, Date_Changer.toDateString(Now), ExpectSel);
		...
		if(UpSuccess == 0 && VoteLogUpSuccess == 0 && ExpLogUpSuccess == 0){
			...
			NextPage = "/passed/VoteANDExpect/Vote_Kanryou.jsp";//まだ作ってない
		}else{
