...
/**
 * Servlet implementation class Kiji_Shinki_Kakunin
 */
public class Kiji_Shinki_Kakunin extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Kiji_Shinki_Kakunin() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		session.setAttribute("errcode", "Rep-004");
...
String Dificultty_S = request.getParameter("difficulty"); //難易度の適正度
		...
		if(Jisu_Wrong || over || few || NGWord != null || notmatch || notOutline || notscore || wrong || notMidashi || notFeature || notEvaluate || notAnswer){
			...
			NextPage = "/passed/Kiji_Report/Kiji_Shinki_Syusei.jsp";
		}else{	
			
			
			NextPage = "/passed/Kiji_Report/Kiji_Shinki_Kakunin.jsp";
		}
	}catch(Exception ex){
		ex.printStackTrace();
		session.setAttribute("errcode", "Rep-004");
