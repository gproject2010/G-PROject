...
/**
 * Servlet implementation class Free_Shinki_Kakunin
 */
public class Free_Shinki_Kakunin extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Free_Shinki_Kakunin() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		session.setAttribute("errcode", "Rep-002");
		...
		String Hatsubainengappi = "0001-01-01";//発売年月日
...
String Dificultty_S = request.getParameter("difficulty"); //難易度の適正度
		...
		*/
		...
		Judge = new Rep_Koumoku(Jisu_Wrong, over, notscore, wrong, few, NGWord, notmatch, nofile, dificultty, story, graphic, sound, volume, controll, promotion, free_S, total, Jiyuten_Koumoku1, Jiyuten_Koumoku2, Jiyuten_Koumoku3, Jiyuten_Koumoku4, Jiyuten_Koumoku5, Jiyuten_Score1, Jiyuten_Score2, Jiyuten_Score3, Jiyuten_Score4, Jiyuten_Score5,
		...
		if(Jisu_Wrong || over || few || NGWord != null || notmatch || notOutline || notscore || wrong || notAnswer){
			
			NextPage = "/passed/Free_Report/Free_Shinki_Syusei.jsp";
		}else{	
			NextPage = "/passed/Free_Report/Free_Shinki_Kakunin.jsp";
		}
