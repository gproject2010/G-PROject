...
<html lang="ja">
<head>
<base href="/G-pro_Service/free_area/Repsc_Ranking_Ruikei.jsp"/>
...
<br>
<br>
<img src="/G-pro_Service/free_area/Ver2_Images/Rep_Ruikei.gif" width="620" height="100" border="0"><br>
<br>
<br>
<b><font size="+1">会員登録直後から今までのレポートスコアの累計を競います。</font></b><br>
<br>
...
<input type="hidden" name="hani" value="ruikei">
...
<table border="1">
  <tbody>
    <tr>
      <td  id="hpb-vmenu1-idle1"><b>&nbsp;順位</b></td>
      <td align="center"><b>プレイヤー<br>
      LV.&nbsp;</b></td>
      <td  id="hpb-vmenu1-idle1"><b>プレイヤーネーム&nbsp;</b></td>
      <td  id="hpb-vmenu1-idle1"><b>&nbsp;.累計レポートスコア</b></td>
    </tr>
    <%for (K_Ranking_TO rankList : ranklist){ %>
      <tr> 
      <td  id="hpb-vmenu1-idle1"><%=rankList.getRank()%>&nbsp;</td>
      <td  id="hpb-vmenu1-idle1"><%=rankList.getplayer_Level()%>&nbsp;</td>
      <td  id="hpb-vmenu1-idle1"><%=HttpUtility.escapeHTML(rankList.getlogin_Name())%>&nbsp;</td>
      <td  id="hpb-vmenu1-idle1"><%=rankList.getreportScore_Kongetsu()%>&nbsp;</td>
      </tr>
      <% } %>
  </tbody>
</table><br>
