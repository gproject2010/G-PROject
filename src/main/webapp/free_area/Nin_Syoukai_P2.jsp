...
<html lang="ja">
<head>
<base href="/G-pro_Service/free_area/Nin_Syoukai_P2.jsp"/>
...
<table border="1">
  <tbody>
    <tr>
      <td><b>&nbsp;生年月日(必須)：</b></td>
      <td><b><input size="4" type="text" name="birthyear">年（西暦)<select name="birthtsuki">
...
<table border="1">
  <tbody>
    <tr>
      ...
      <td><b>&nbsp;<input size="7" type="text" name="addressno"></b></td>
    </tr>
  </tbody>
</table>
※”-”（ハイフン）は入れずに入力してください。(入力例:9501234）
<b><br>
</b>
