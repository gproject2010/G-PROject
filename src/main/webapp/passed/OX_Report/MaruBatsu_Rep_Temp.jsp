...
<html lang="ja">
<head>
<base href="/G-pro_Service/passed/OX_Report/MaruBatsu_Rep_Temp.jsp"/>
...
<table border="1">
  <tbody>
	...
	<span id="jiyuten_totalscore_hyouji">---</span>点
      <input size="6" type="hidden" maxlength="6" name="トータル" value="0" id="jiyuten_totalscore_set">
	</td>
      <td align="center"><span id="jiyuten_maxtotalscore_hyouji">---</span>点
      <input size="6" type="hidden" maxlength="6" name="トータル" value="0" id="jiyuten_maxtotalscore_set">
</td>
    </tr>
  </tbody>
</table>
...
<br>
<br>
<img src="/G-pro_Service/image/Good_Logo2.gif" width="266" height="58" border="0" alt="↑GOOD!!">このゲームの良かった所(必須)<br>
<textarea rows="5" cols="100" name="goodies" id="count_area2" maxlength="1000"></textarea><br>
※全角1000文字以内(あと<span id="mojisu2">---</span>文字)<br>
<br>
<img src="/G-pro_Service/image/Bad_Logo2.gif" width="175" height="51" border="0" alt="↓BAD…">今後の課題<br>
<textarea rows="5" cols="100" name="badies" id="count_area3" maxlength="1000"></textarea><br>
