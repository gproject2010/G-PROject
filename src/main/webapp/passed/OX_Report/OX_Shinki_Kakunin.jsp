...
<%= HttpUtility.escapeHTML(hyouka.getInterview6()) %><br>
<br>
<br>
<img src="/G-pro_Service/image/Goodies_Logo.gif" width="67" height="52" border="0" alt="Good!">このゲームの良かった所(必須)</p><br>
...
<input type="hidden" name="rep" value="newox">
<!-- <p align="center"><input type="image" name="submit" src="/G-pro_Service/image/Touroku_Button.gif" alt="この内容で送信する"  width="59" height="47" border="0">　　<a href="#" onClick="history.back(); return false;"><img src="/G-pro_Service/image/Rep_Kakinaoshi.gif" alt="レポートを書き直す"></a></p>-->
<input class="tourokubutton" type="submit" name="submit" value="この内容で送信する">
<dl>
      <dd class="tourokubutton"><a href="/G-pro_Service/passed/Free_Report/OX_Shinki_Syusei.jsp">内容を修正する</a></dd>
    </dl>
    <dl>
