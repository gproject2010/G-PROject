...
<%@ page import="rep_upload.Rep_Koumoku" %>
    <%@ page import="rep_upload.OX_Shinki_Kakunin" %>
...
<form action="/G-pro_Service/OX_Shinki_Kakunin" method="post">
<p><br>
<%if(hyouka.isJisu_wrong() == true){ %>
...
<font color="ff00ff" size="+1">評価欄の合計が自由点欄のものと一致していません。<br>
...
<table border="1" align="left">
  <tbody>
    ...
    <tr>
      <td>&nbsp;ボリューム度・ハマり度</td>
      <td>
      <input size="5" type="text" maxlength="5" name="volume" value="<%=hyouka.getvolume() %>" id="volume" class="score">点
      </td>
      <td align="center">/10点&nbsp;</td>
    </tr>
    <tr>
...
<table border="1">
  <tbody>
	...
	<span id="jiyuten_totalscore_hyouji"><%=hyouka.getjiyuten_scoretotal() %></span>点
      <input size="6" type="hidden" maxlength="6" name="total" value="<%=hyouka.getjiyuten_scoretotal() %>" id="jiyuten_totalscore_set">
	</td>
      <td align="center"><span id="jiyuten_maxtotalscore_hyouji"><%=hyouka.getjiyuten_maxscoretotal() %></span>点
      <input size="6" type="hidden" maxlength="6" name="total" value="<%=hyouka.getjiyuten_maxscoretotal() %>" id="jiyuten_maxtotalscore_set">
</td>
    </tr>
  </tbody>
</table>
...
<%}else{ %>
あなたの回答:<%=HttpUtility.escapeHTML(hyouka.getKonyu_houhou()) %><br>
<% } %>
</p>
<br>
<br>
...
<% } %>
<br>
Q3:このゲームに関する情報で、見聞きしたことのあるもすべてにチェックを入れてください。<br>
<br>
<%if(hyouka.isnotAnswer() == true){ %>
...
<br>
<br>
Q4:このゲームに関する情報で、プレーする最大の決め手となったものを1つ選んでください。(必須)<br>
<br>
<%if(hyouka.isnotAnswer() == true){ %>
...
<input type="hidden" name="shinkiflg" value="true">
<!-- <p align="center"><input type="image"  src="/G-pro_Service/image/Kakutei_Button.gif" alt="確定" name="submit" width="61" height="48" border="0"></p><br>-->
