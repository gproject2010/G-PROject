...
<html lang="ja">
<head>
<base href="/G-pro_Service/passed/GPRO_Riron/Ronbun_Hensyu_Syusei.jsp">
...
<% } %>
<p><iframe src="/G-pro_Service/Ronbun_BodyLoad/<%=newdata.getHTMLFileName() %>?time=hensyumae" width="640" height="1280">
