...
<html lang="ja">
<head>
<base href="/G-pro_Service/passed/NewGames/NewGame_Rep_Temp.jsp"/>
...
<form action="/G-pro_Service/NewGame_Rep_Kakunin?rep_syubetsu=newgame" method="post">
<b><textarea rows="8" cols="50" name="comment"></textarea></b>
<p><b>(最大全角400文字以内）</b></p>
