...
<p><b>${sessionScope.action}の変更処理が完了しました。引き続き<br>
G-PROjectをお楽しみください!</b></p>
<!-- <p align="center">　　<a href="/G-pro_Service/passed/Kaiin_Menu_Top.jsp"><img src="/G-pro_Service/image/BacktoKaiinTop.gif" width="149" height="43" border="0"></a></p>-->
<dl>
      <dd class="tourokubutton"><a href="/G-pro_Service/AuthenticationController">会員メニューへ戻る</a></dd>
    </dl>
<% session.removeAttribute("ninsyou_jyouhou"); %>
