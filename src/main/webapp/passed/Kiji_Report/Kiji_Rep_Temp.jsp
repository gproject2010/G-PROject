...
<html lang="ja">
<head>
<base href="/G-pro_Service/passed/Kiji_Report/Kiji_Rep_Temp.jsp"/>
...
<table border="1" align="left">
  <tbody>
    ...
    <tr>
      ...
      <input size="6" type="hidden" maxlength="6" name="free_s" value="0" id="jiyuten_set" class="score">点
      </td>
      <td>&nbsp;/30点</td>
    </tr>
    <tr>
...
<br>
<input size="45" type="text" maxlength="75" name="midashi" value="「このゲームの特徴」を表す見出しをここに入力してください"><br>
※全角40文字以内で入力してください。<br>
<p align="left"><font size="+2">自分が思うこのゲームの特徴・セールスポイント</font>(必須)</p>
<textarea rows="5" cols="100" name="feature" id="count_area2" maxlength="500"></textarea>　<br>
※全角500文字以内(あと<span id="mojisu2">---</span>文字)<br>
<br>
<font size="+2">このゲームの評価</font>(必須)
<textarea rows="5" cols="100" name="evaluate" id="count_area3" maxlength="500"></textarea><br>
※全角500文字以内(あと<span id="mojisu3">---</span>文字)<br>
<br>
<br>
<input type="hidden" name="shinkiflg" value="false"></p>
<!-- <p align="center"><input type="image" alt="確定" name="submit" src="/G-pro_Service/Kakutei_Button.gif" width="61" height="48" border="0">　　　<a href="/G-pro_Service/passed/G_SeachResult.jsp"><img src="/G-pro_Service/passed/GData_Images/BacktoSerchResult.gif"  alt="検索結果に戻る"></a>　　　<a href="/G-pro_Service/passed/Kaiin_Menu_Top.jsp"><img src="/G-pro_Service/passed/GData_Images/BacktoKaiinTop.gif" width="149" height="43" border="0"></a></p>-->
