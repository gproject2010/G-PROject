...
<br>
<br>
<p><font size="+2"><%=HttpUtility.escapeHTML(bestrep.getmidashi()) %></font></p>
<p align="left"><font size="+2">自分が思うこのゲームの特徴・セールスポイント(必須)：</font></p>
<p><pre><%=HttpUtility.escapeHTML(bestrep.getfeature()) %></pre>
　<br>
※全角1000文字以内
<p><br>
<font size="+1">このゲームの評価(必須)：</font></p><br>
<p><pre><%=HttpUtility.escapeHTML(bestrep.getevaluate()) %></pre>
<br>
※全角1000文字以内
<br>
<br>
