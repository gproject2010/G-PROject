...
<html lang="ja">
<head>
<base href="/G-pro_Service/passed/Kiji_Report/Kiji_Shinki_Syusei.jsp"/>
...
<form action="/G-pro_Service/Kiji_Shinki_Kakunin" method="post">
<br>
<br>
<br>
<font size="+2">レポート種別：紹介記事レポート・新規登録</font>
...
<%if(kijihyouka.isJisu_wrong() == true){ %>
<font color="ff00ff" size="+1">字数が制限を超えている項目があります。</font><br>
<% } %>

<%if(kijihyouka.isover() == true){ %>
<font color="ff00ff" size="+1">評価点数に満点を超えている項目があります。</font><br>
<% } %>

<%if(kijihyouka.isfew() == true){%>
<font color="ff00ff" size="+1">評価点数にマイナスの値が入力されています。<br>
入力欄の-(ハイフン)を外してください。</font><br>
<% } %>

<%if(kijihyouka.isnotscore() == true){ %>
<font color="ff00ff" size="+1">評価点数に入力されていない項目があります。</font><br>
<% } %>

<%if(kijihyouka.isnotmatch() == true){ %>
<font color="ff00ff" size="+1">評価欄の合計がと自由点欄のものと一致していません。<br>
2つの値が等しくなるように、再設定してください。</font><br>
<% } %>

<% if(kijihyouka.isnotOutline() == true){ %>
<font color="ff00ff" size="+1">「ゲームの概要・ストーリー」が記述されていません。</font><br>
<% } %>

<% if(kijihyouka.isnotMidashi() == true){ %>
<font color="ff00ff" size="+1">「見出し」の欄が記述されていません。</font><br>
<% } %>

<% if(kijihyouka.isnotFeature() == true){ %>
<font color="ff00ff" size="+1">「自分が思うこのゲームの特徴・セールスポイント」の欄が記述されていません。</font><br>
<% } %>

<% if(kijihyouka.isnotEvaluate() == true){ %>
<font color="ff00ff" size="+1">「このゲームの評価」の欄が記述されていません。</font><br>
<% } %>

<% if(kijihyouka.isnotAnswer() == true){ %>
<font color="ff00ff" size="+1">選択もしくは入力されていない項目があります。</font><br>
<% } %>

<% if(kijihyouka.iswrong() == true){%>
<font color="red" size="+1">不正な値が入力されている項目があります。</font><br>
<% } %>

<% if(kijihyouka.getNGWord() != null){ %>
<font color="red" size="+1">記述内容に禁止ワード(公開できない単語)が含まれています。<br>
(ヒットした入力値:<%=kijihyouka.getNGWord() %>)訂正して再試行してください。</font><br>
<% } %>
<br>
ゲームタイトル：<br>
...
<br>
評価点数(必須)※整数または第2位以内の小数で入力してください<br>
<table border="1">
  <tbody>
    <tr>
      <td>&nbsp;評価項目</td>
    ...
    <tr>
      <td>&nbsp;難易度の適正度</td>
      <td>
      <input size="4" type="text" maxlength="4" name="difficulty" value="<%=kijihyouka.getdificultty() %>" id="dificultty" class="score">点
      </td>
      <td>&nbsp;/10点</td>
    </tr>
    <tr>
      ...
      <td>
      <input size="4" type="text" maxlength="4" name="story" value="<%=kijihyouka.getstory() %>" id="story" class="score">点
      </td>
      <td>&nbsp;/10点</td>
    </tr>
    <tr>
      <td>&nbsp;グラフィック </td>
      <td>
      <input size="4" type="text" maxlength="4" name="graphic" value="<%=kijihyouka.getgraphic() %>" id="graphic" class="score">点
      </td>
    ...
    <tr>
      <td>&nbsp;サウンド</td>
      <td>
      <input size="4" type="text" maxlength="4" name="sound" value="<%=kijihyouka.getsound() %>" id="sound" class="score">点
      </td>
      <td>&nbsp;/10点</td>
    </tr>
    <tr>
      <td>&nbsp;ボリューム度・ハマり度</td>
      <td>
      <input size="4" type="text" maxlength="4" name="volume" value="<%=kijihyouka.getvolume() %>" id="volume" class="score">点
      </td>
      <td align="center">/10点&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;操作性</td>
      <td>
      <input size="4" type="text" maxlength="4" name="controll" value="<%=kijihyouka.getcontroll() %>" id="controll" class="score">点
      </td>
      <td align="center">&nbsp;/10点</td>
    </tr>
    <tr>
      <td>&nbsp;プロモーション</td>
      <td>
      <input size="4" type="text" maxlength="4" name="promotion" value="<%=kijihyouka.getpromotion() %>" id="promotion" class="score">点
      </td>
      <td>/10点&nbsp;</td>
    </tr>
    <tr>
      ...
      <input size="5" type="hidden" maxlength="5" name="free_s" value="<%=kijihyouka.getfree_S() %>" id="jiyuten_set" class="score">点
      </td>
      <td>&nbsp;/30点</td>
    </tr>
    <tr>
      ...
      <input size="6" type="hidden" maxlength="6" name="total" value="<%=kijihyouka.gettotal() %>" id="totalscore_set">
      </td>
      <td>&nbsp;/100点</td>
    </tr>
  </tbody>
...
<table border="1">
  <tbody>
    ...
    <tr>
      <td><input size="20" type="text" name="jiyuten_koumoku1" value="<%=HttpUtility.escapeHTML(kijihyouka.getjiyuten_koumoku1()) %>"></td>
      <td>&nbsp;<input size="5" type="text" maxlength="5" name="jiyuten_score1" value="<%=kijihyouka.getjiyuten_score1() %>">点</td>
      <td>&nbsp;<input size="5" type="text" maxlength="5" name="jiyuten_maxscore1" value="<%=kijihyouka.getjiyuten_maxscore1() %>">点</td>
    </tr>
    <tr>
      <td><input size="20" type="text" name="jiyuten_koumoku2" value="<%=HttpUtility.escapeHTML(kijihyouka.getjiyuten_koumoku2()) %>"></td>
      <td>&nbsp;<input size="5" type="text" maxlength="5" name="jiyuten_score2" value="<%=kijihyouka.getjiyuten_score2() %>">点</td>
      <td>&nbsp;<input size="5" type="text" maxlength="5" name="jiyuten_maxscore2" value="<%=kijihyouka.getjiyuten_maxscore2() %>">点</td>
    </tr>
    <tr>
      <td><input size="20" type="text" name="jiyuten_koumoku3" value="<%=HttpUtility.escapeHTML(kijihyouka.getjiyuten_koumoku3()) %>"></td>
      <td>&nbsp;<input size="5" type="text" maxlength="5" name="jiyuten_score3" value="<%=kijihyouka.getjiyuten_score3() %>">点</td>
      <td>&nbsp;<input size="5" type="text" maxlength="5" name="jiyuten_maxscore3" value="<%=kijihyouka.getjiyuten_maxscore3() %>">点</td>
    </tr>
    <tr>
      <td><input size="20" type="text" name="jiyuten_koumoku4" value="<%=HttpUtility.escapeHTML(kijihyouka.getjiyuten_koumoku4()) %>"></td>
      <td>&nbsp;<input size="5" type="text" maxlength="5" name="jiyuten_score4" value="<%=kijihyouka.getjiyuten_score4() %>">点</td>
      <td>&nbsp;<input size="5" type="text" maxlength="5" name="jiyuten_maxscore4" value="<%=kijihyouka.getjiyuten_maxscore4() %>">点</td>
    </tr>
    <tr>
      <td><input size="20" type="text" name="jiyuten_koumoku5" value="<%=HttpUtility.escapeHTML(kijihyouka.getjiyuten_koumoku5()) %>"></td>
      <td>&nbsp;<input size="5" type="text" maxlength="5" name="jiyuten_score5" value="<%=kijihyouka.getjiyuten_score5() %>">点</td>
      <td>&nbsp;<input size="5" type="text" maxlength="5" name="jiyuten_maxscore5" value="<%=kijihyouka.getjiyuten_maxscore5() %>">点</td>
    </tr>
    <tr>
      <td>&nbsp;自由点トータル</td>
      <td align="center">
	<span id="jiyuten_totalscore_hyouji"><%=kijihyouka.getjiyuten_scoretotal() %></span>点
      <input size="6" type="hidden" maxlength="6" name="total" value="<%=kijihyouka.getjiyuten_scoretotal() %>" id="jiyuten_totalscore_set">
	</td>
      <td align="center"><span id="jiyuten_maxtotalscore_hyouji"><%=kijihyouka.getjiyuten_maxscoretotal() %></span>点
      <input size="6" type="hidden" maxlength="6" name="total" value="<%=kijihyouka.getjiyuten_maxscoretotal() %>" id="jiyuten_maxtotalscore_set">
</td>
    </tr>
  </tbody>
</table>
...
<br>
<p>購入方法：<%if(kijihyouka.isnotAnswer() == true){%>(もう一度入力してください)<% } %>このゲームをどのように入手しましたか?以下から選んでください。(必須)<br>
<br>
<%if(kijihyouka.isnotAnswer() == true){ %>
...
<input type="radio" name="konyu_houhou" value="アーケード版をプレー">アーケード版をプレー<br>
<input type="radio" name="konyu_houhou" value="覚えていない">覚えていない
<%}else{ %>
あなたの回答:<%=HttpUtility.escapeHTML(kijihyouka.getKonyu_houhou()) %><br>
<% } %>
</p>
<br>
<br>
<p><br>
共通インタビュー項目<%if(kijihyouka.isnotAnswer() == true){%>(もう一度入力してください)<% } %><br>
<br>
...
<%}else{%>
あなたの回答：<%for(String Inter1 : kijihyouka.getInterview1()){ %><%=HttpUtility.escapeHTML(Inter1) + ", " %>
<% } %>
<% } %>
<br>
...
<% }else{ %>
あなたの回答：<%=HttpUtility.escapeHTML(kijihyouka.getInterview2()) %>
<% } %>
<br>
...
<% }else{ %>
あなたの回答:<% for(String inter3 : kijihyouka.getInterview3()){ %><%= HttpUtility.escapeHTML(inter3) + ", " %><br>
<% } %>
<% } %>
<br>
<br>
Q4:このゲームに関する情報で、プレーの最大の決め手となったものを1つ選んでください。(必須)<br>
<br>
<%if(kijihyouka.isnotAnswer() == true){ %>
...
<% }else{ %>
あなたの回答：<%=HttpUtility.escapeHTML(kijihyouka.getInterview4()) %>
<% } %>
<br>
Q5:このゲームをプレーした理由として当てはまるものすべてにチェックを入れてください。<br>
<br>
<%if(kijihyouka.isnotAnswer() == true){ %>
...
<% }else{ %>
あなたの回答:<% for(String inter5 : kijihyouka.getInterview5()){ %><%= HttpUtility.escapeHTML(inter5) + ", " %><br>
<% } %>
<% } %>
<br>
...
<br>
<% if(kijihyouka.isnotAnswer() == true){ %>
<input type="radio" name="Interview6" value="絶対にプレーすると思う">絶対に購入すると思う<br>
<input type="radio" name="Interview6" value="たぶんプレーすると思う">たぶん購入すると思う<br>
<input type="radio" name="Interview6" value="内容による">内容による<br>
<input type="radio" name="Interview6" value="プレーすることはないと思う">購入することはないと思う<br>
<input type="radio" name="Interview6" value="絶対にプレーしないと思う">絶対に購入しないと思う<br>
<input type="radio" name="Interview6" value="今の状況では何とも言えない">今の状況では何とも言えない<br>
<br>
<% }else{ %>
あなたの回答：<%=HttpUtility.escapeHTML(kijihyouka.getInterview6()) %>
<% } %>
<br>
<input size="45" type="text" maxlength="50" name="midashi" value="<%=HttpUtility.escapeHTML(kijihyouka.getmidashi())%>" style="font-size : x-large;font-weight : bold;"><br>
※全角40文字以内で入力してください。<br>
<font size="+2">自分が思うこのゲームの特徴・セールスポイント</font>(必須)
<textarea rows="5" cols="100" name="feature"><%=HttpUtility.escapeHTML(kijihyouka.getfeature())%></textarea>　<br>
※全角500文字以内で入力してください。なお目安としてフォームの横幅は全角50文字分です<br>
<p><br>
<font size="+2">このゲームの評価</font>(必須)</p>
<textarea rows="5" cols="100" name="evaluate"><%= HttpUtility.escapeHTML(kijihyouka.getevaluate())%></textarea><br>
※全角500文字以内で入力してください。なお目安としてフォームの横幅は全角50文字分です<br>
<br>
<br>
<font color="#0000ff">※レポートの登録を中止するにはブラウザの「閉じる」ボタンをクリックしてください</font>
<!-- <p align="center"><input type="image" src="/G-pro_Service/Kakutei_Button.gif" width="61" height="48" border="0" alt="確定" name="submit"></p>-->
