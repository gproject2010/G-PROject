...
<title>自由形式レポートテンプレート(入力内容確認)</title>
</head>
...
<br>
<input type="hidden" name="rep" value="newfree">
<p><b><font size="+2" color="#0000ff">注意:レポートは一度アップロードすると加筆・訂正は一切できません!</font></b></p>
<!-- <p align="center"><input type="image" name="submit" src="/G-pro_Service/image/Touroku_Button.gif" alt="この内容で送信する" width="59" height="47" border="0"><a href="/G-pro_Service/passed/Free_Report/Free_Rep_Syusei.jsp"><img src="/G-pro_Service/image/Rep_Kakinaoshi.gif" alt="レポートを書き直す"></a>-->
<input class="tourokubutton" type="submit" name="submit" value="この内容で送信する">
<dl>
      <dd class="tourokubutton"><a href="/G-pro_Service/passed/Free_Report/Free_Shinki_Syusei.jsp">内容を修正する</a></dd>
    </dl>
    <dl>
